...
const IndexPage = ({ data }, props) => (
  <Layout>
    ...
    <RtoSection>
      ...
      <ContentWrapper>
    <RtoCard>
       <Image fluid={data.watsonLogo.childImageSharp.fluid} alt="Watson Barn Rentals, LLC" />
       <div className="card-body">
         <h3>Watson Barn Rentals, LLC</h3>
         <p>Watson Barn Rentals provides Rent-to-Own services to shed builders and dealer all across the Southeast! We'd love to help you grow!</p>
         <Button size="large" href="https://watsonbarnrentals.com/become-a-dealer/" css={css`color: #006595 !important;`}  target="_BLANK" rel="noopener noreferrer">Become a Dealer</Button>
         <Button size="large" href="https://watsonbarnrentals.com/faqs/" css={css`color: #006595 !important;`} target="_BLANK" rel="noopener noreferrer">Rent-to-Own FAQ's</Button>
       </div>
    </RtoCard>
      </ContentWrapper>
  </Layout>
